...
namespace vtkio
{
	namespace tables
	{
		...
		inline std::string getAttributeTypeString(const vtkio::tables::AttributeType vtk_attribute_type)
		{
			switch (vtk_attribute_type) {
			case vtkio::tables::AttributeType::Scalars: return "SCALARS";
			case vtkio::tables::AttributeType::Vectors: return "VECTORS";
			case vtkio::tables::AttributeType::Tensors: return "TENSORS";
			case vtkio::tables::AttributeType::Normals: return "NORMALS";
			case vtkio::tables::AttributeType::TextureCoordinates: return "TextureCoordinates";
			case vtkio::tables::AttributeType::FieldData: return "FIELD";
			default:
